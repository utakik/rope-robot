...
const PRESETS = {
  soft: {
    KX:   [0.7,0.10,0.15,0.20],
    KY:   [0.10,0.11,0.12,0.13],
    DAMP: [0.94,0.94,0.94,0.93],
    REST: 48, ITER: 6, TIP_BIAS: 0.7
  },
  crisp: {
    KX:   [0.18,0.20,0.22,0.25],
    KY:   [0.11,0.12,0.13,0.14],
    DAMP: [0.93,0.93,0.92,0.92],
    REST: 44, ITER: 5, TIP_BIAS: 0.7
  },
  tail: {
    KX:   [0.16,0.18,0.20,0.23],
    KY:   [0.10,0.11,0.12,0.13],
    DAMP: [0.94,0.94,0.93,0.93],
